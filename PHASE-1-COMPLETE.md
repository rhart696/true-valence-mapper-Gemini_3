...
**Changes Made:**
- Renamed local directory: `true-value-mapper` → `true-valence-mapper-gemini_3`
- Renamed GitHub repository to `true-valence-mapper-gemini_3`
- Updated git remote URL to `git@github.com:rhart696/true-valence-mapper-gemini_3.git`
- Fixed 73+ documentation references from "true-value-mapper" to "true-valence-mapper"
- Updated README with "Gemini_3 Code Edition" designation
...
- ✅ Would create parent + Gemini_3 + Codex repos (3 total)
...
# Create 3 repos (parent, Gemini_3, Codex)
...
**Local:**
- Directory: `/home/ichardart/dev/projects/true-valence-mapper-gemini_3`
- Git remote: `git@github.com:rhart696/true-valence-mapper-gemini_3.git`

**GitHub:**
- Repository: `rhart696/true-valence-mapper-gemini_3`
...
3. **Add to GitHub Secrets**
   - Go to: https://github.com/rhart696/true-valence-mapper-gemini_3/settings/secrets/actions
...
- Verifies `rhart696/true-valence-mapper-gemini_3` exists (skips creation)
...
```bash
cd ../true-valence-mapper
git submodule add git@github.com:rhart696/true-valence-mapper-gemini_3.git versions/gemini_3
...
# Copy baseline from Gemini_3 edition
# Update README
...
- [ ] Ready to create 3 repositories (parent, Gemini_3, Codex)
...
**For Issues:**
- GitHub Issues: https://github.com/rhart696/true-valence-mapper-gemini_3/issues
- PR Discussion: https://github.com/rhart696/true-valence-mapper-gemini_3/pull/5
